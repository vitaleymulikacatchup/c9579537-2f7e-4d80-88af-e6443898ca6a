...
export const metadata: Metadata = {
  title: "India International School | World-Class Education in India",
  description: "Discover excellence at India International School. IB curriculum, diverse community, sports & arts programs. Apply today for admissions.",
  keywords: "international school, IB curriculum, admissions, education, student programs",
  metadataBase: new URL("https://www.indianinternationalschool.com"),
  alternates: {
    canonical: "https://www.indianinternationalschool.com"
  },
  openGraph: {
    title: "India International School - Excellence in Education",
    description: "Join our community of global learners. World-class IB curriculum, modern facilities, and holistic development programs.",
    type: "website",
    siteName: "India International School"
  },
  twitter: {
    card: "summary_large_image",
    title: "India International School",
    description: "Excellence in education for globally-minded learners"
  },
  robots: {
    index: true,
    follow: true
